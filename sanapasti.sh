...
getgau(){
  echo "${green}fMengambil url dari wayback,commoncrawl,otx,urlscan...${reset}"
...
get_interesting(){
	echo -e "${green}Menemukan data yang tidak biasa...${reset}"
...
logo(){
  # Fungsi memasukkan logo di command dalam bahasa bash
  echo "${yellow}
